...
public class MLRTSms {
	public static String send(String mobile,String content) {
		...
		String encode = "UTF-8";
		String username = "yhhd"; // 用户名
		String password_md5 = "7240835ee7502289c76f5e9bd4cddb8d"; // 密码
		String apikey = "ec315b55a76455ddd6789e192b8b670a"; // apikey秘钥（请登录 http://m.5c.com.cn
		...
		try {
			...
			buffer.append("http://m.5c.com.cn/api/send/index.php?username=" + username + "&password_md5=" + password_md5 + "&mobile="
					+ mobile + "&apikey=" + apikey + "&content=" + contentUrlEncode + "&encode=" + encode);
