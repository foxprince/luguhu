...
public class SaleUnitController extends GenericController<SaleUnit,Long> {
    ...
    public String addOrEdit(HttpServletRequest request,@ModelAttribute SaleUnit t, final RedirectAttributes redirectAttributes) throws EntityNotFound {
